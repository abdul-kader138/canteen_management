...
<script>
    ...
    $(document).ready(function () {
        oTable = $('#SupData').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('meal/getFoodHistory') ?>',
            ...
            {column_number: 2, filter_default_label: "[<?=lang('Emp_Name');?>]", filter_type: "text", data: []},
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-users"></i><?= lang('Food_Order_Details'); ?></h2>
